...
class RegisterSerializer(UserSerializer):
    ...
    class Meta:
        model = User
        # List of all the fields that can be include in a request or a response
        
        fields = '__all__'
        #Currently it is not necessary to declarate as shows bellow
        # field = ['id', 'bio', 'avatar', 'email', 'username', 'first_name', 
        #          'last_name','password']
